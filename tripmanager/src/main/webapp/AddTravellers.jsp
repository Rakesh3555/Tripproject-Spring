...
<script>
var travelerCount = 1; // Initialize a counter for travelers
...
function addTextBox() {
    ...
    maleRadio.name = "gender[" + travelerCount + "][]"; // Unique name for each traveler
    ...
    femaleRadio.name = "gender[" + travelerCount + "][]"; // Unique name for each traveler
    ...
    travelerCount++; // Increment traveler counter for the next traveler
}
</script>
